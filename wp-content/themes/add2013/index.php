...
<body>
  ...
  <section class="social">
    <div class="btn-social"><a href="" class="icon-twitter"></a></div>
    <div class="btn-social"><a href="" class="icon-facebook"></a></div>
  </section>
  <!-- End Social -->
  ...
  <header class="header container">
    <div class="row">
      <div class="section-screen">
        ...
        <h2>Prepare o computador e a pipoca</h2>
        <div class="description-screen">
          Juntamos o visual de uma cidade paradisíaca, um lugar que respira arte e separamos um dia para conversar apenas sobre programação. O resultado disso tudo é uma experiência incrível sobre desenvolvimento em diversas linguagens.
        </div>
      </div>
    </div>
  </header>
